...
INT8U  MyOSTaskCreate(void(*task)(void *p_arg), void *p_arg, OS_STK *ptos, INT8U prio, INT16U CompTime, INT16U Deadline) {
	OS_STK    *psp;
	INT8U      err;
	...
	if (OSTCBPrioTbl[prio] == (OS_TCB *)0) { /* Make sure task doesn't already exist at this priority  */
		...
		err = OS_TCBInit(prio, psp, (OS_STK *)0, prio/*set prio as id*/, 0, (void *)0, 0);
		if (err == OS_NO_ERR) {
			OSTCBPrioTbl[prio]->CompTime = CompTime;
			OSTCBPrioTbl[prio]->Deadline = Deadline;
